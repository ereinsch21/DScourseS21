...
# what is the best value of lambda?
top_acc  <- show_best(rec_res_tree, metric = "accuracy")
best_acc <- select_best(rec_res_tree, metric = "accuracy")
...
# what is the best value of lambda?
top_acc  <- show_best(rec_res_nnet, metric = "accuracy")
best_acc <- select_best(rec_res_nnet, metric = "accuracy")
...
# what is the best value of lambda?
top_acc  <- show_best(rec_res_knn, metric = "accuracy")
best_acc <- select_best(rec_res_knn, metric = "accuracy")
...
# what is the best value of lambda?
#top_acc  <- show_best(rec_res_svm, metric = "accuracy")
#best_acc <- select_best(rec_res_svm, metric = "accuracy")
#final_svm <- finalize_workflow(rec_wf_svm,
#                               best_acc)
...
datasummary_df(all_ans %>% select(-.metric,-.estimator,-mean,-n,-std_err),output="ps10.tex") %>% print
