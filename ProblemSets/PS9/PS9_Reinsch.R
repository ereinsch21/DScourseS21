...
# The in-sample RMSE is 0.220 and the R Squared is 0.768
top_rmse %>% print(n = 1)
# The best value of lambda 0.00222
...
# The out of sample RMSE is 0.219 and the R-squared is 0.770

top_rmse_out %>% print(n=1)
...
# The out-of-sample RMSE is 0.219 and the R-squared is 0.776
# The optimal value of lambda is much smaller now, lambda = 0.0000000001
